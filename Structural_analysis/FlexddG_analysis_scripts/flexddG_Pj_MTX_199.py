...
rosetta_scripts_path = os.path.expanduser("/prg/rosetta/2017.52/main/source/bin/rosetta_scripts.static.linuxgccrelease")
nstruct = 50 # Normally 35
...
residue_to_mutate = ('A', 199, '') # Residue position to perfrom saturation mutatagenesis. Format: (Chain, PDB residue number, insertion code).
...
def run_flex_ddg_saturation( name, input_path, input_pdb_path, chains_to_move, mut_aa, nstruct_i ):
    ...
    ####
    cp_MTX = 'cp MTX.params ' + output_directory + '/'
    cp_NAP = 'cp NAP.params ' + output_directory + '/'
    os.popen(cp_MTX) 
    os.popen(cp_NAP)
    MTX_path = '/project/chlandry/users/frrou130/flex_ddG_Pj/MTX_140423/run-folder_180423/' + output_directory + '/MTX.params'
    NAP_path = '/project/chlandry/users/frrou130/flex_ddG_Pj/MTX_140423/run-folder_180423/' + output_directory + '/NAP.params'
    ####
    ...
    flex_ddg_args = [
        ...
        ####
        '-extra_res_fa ' + NAP_path,
        '-extra_res_fa ' + MTX_path,
        ####
        '-overwrite',
